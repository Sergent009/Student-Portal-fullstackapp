<template>
  <div class="container" v-if="!animation">
    ...
    <div class="page" v-if="!showSidebar">
      ...
      <pre>
The University of Karachi was established through the parliament as a federal university
...
business, law, and social sciences.</pre
      ...
      <img
        class="uniPic"
        src="https://qiyamgah.com/wp-content/uploads/2023/05/karachi-university-caters-846-candidates-for-admission-test-1611493040-8828-1024x614.jpg"
        alt=""
      />
    </div>
  </div>
